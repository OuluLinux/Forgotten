...
my @download = ( {'url' => "ftp://ftp.gnu.org/gnu/gcc/gcc-$gcc_version/gcc-core-$gcc_version.tar.bz2",
                 ...
                 {'url' => "http://www.nasm.us/pub/nasm/releasebuilds/$nasm_version/nasm-$nasm_version.tar.bz2",
                  ...
                  'arch' => 'i686-fos amd64-fos i686-elf amd64-elf'} );

my @patch = ( {'cwd' => "gcc-$gcc_version",
               'name' => "Gcc fos target patch",
               'flags' => '-p1',
               'input' => 'fos-gcc.patch',
               'arch' => 'all'},
              {'cwd' => "binutils-$binutils_version",
               'name' => "Binutils fos target patch",
               'flags' => '-p1',
               'input' => 'fos-binutils.patch',
               'arch' => 'all'} );
...
my @compile = ( {'dir' => "nasm-$nasm_version",
                ...
                {'dir' => "gcc-$gcc_version",
                 ...
                 'arch' => 'i686-fos amd64-fos x86_64-fos i686-elf amd64-elf arm-elf ppc-elf powerpc-elf',
                 'test' => './bin/!TARGET-gcc'},
                {'dir' => "gcc-$gcc_version",
                 'name' => "Gcc (mips)",
...
die "Please use target '[arch]-fos'." unless $target =~ /(i686|x86_64|arm|amd64|mips64el|powerpc)/; # '*-fos';
