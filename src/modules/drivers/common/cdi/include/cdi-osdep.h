...
#define CDI_DRIVER(name, drvobj, deps...) \
    static void mod_entry() {(drvobj).drv.init(); cdi_fos_walk_dev_list_init((struct cdi_driver*)&(drvobj));} \
    static void mod_exit() {cdi_fos_walk_dev_list_destroy((struct cdi_driver*)&(drvobj)); (drvobj).drv.destroy();} \
 ...
 *               pointers.
 */
void cdi_fos_walk_dev_list_init(struct cdi_driver *dev);
 ...
 *               pointers.
 */
void cdi_fos_walk_dev_list_destroy(struct cdi_driver *dev);
