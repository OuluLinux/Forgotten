...
class BeagleGpio
{
    ...
    private:
        ...
        void initspecific(int n, volatile unsigned int *gpio)
        {
            ...
            /// \todo When implementing within Forgotten, we'll have a much nicer
...
extern "C" void __start(uint32_t r0, uint32_t machineType, struct atag *tagList)
{
    ...
    writeStr(3, "Forgotten for the BeagleBoard\r\n\r\n");
    ...
    writeStr(3, "Now starting the Forgotten kernel (can take a while, please wait).\r\n\r\n");
    main(bs);
#endif
